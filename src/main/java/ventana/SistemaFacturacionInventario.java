...
import controlador.ClienteController; // Importación añadida para el controlador
...
public class SistemaFacturacionInventario extends JFrame {
	...
	public SistemaFacturacionInventario() {
		...
		// CAMBIO AQUÍ: Crear el ClienteController primero y pasarlo a VistaClientes
		ClienteController clienteController = new ClienteController();
		VistaClientes vistaClientes = new VistaClientes(clienteController);
